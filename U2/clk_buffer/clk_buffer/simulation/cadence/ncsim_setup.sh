...
TOP_LEVEL_NAME="clk_buffer"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/opt/intelFPGA/18.0/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/arriaii_hssi/
mkdir -p ./libraries/arriaii_pcie_hip/
mkdir -p ./libraries/arriaii/
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/arriaii_hssi_components.vhd"      -work arriaii_hssi    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/arriaii_hssi_atoms.vhd"           -work arriaii_hssi    
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/arriaii_pcie_hip_components.vhd"  -work arriaii_pcie_hip
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/arriaii_pcie_hip_atoms.vhd"       -work arriaii_pcie_hip
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/arriaii_atoms.vhd"                -work arriaii         
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/arriaii_components.vhd"           -work arriaii         
fi

# ----------------------------------------
# compile design files in correct order
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/clk_buffer_altclkctrl_0.vhd" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clk_buffer.vhd"                                                                                   
fi
