...
module  clk_buffer_altclkctrl_0_sub
	( 
	ena,
	inclk,
...
`endif
	...
	assign
		clkselect = {2{1'b0}},
		outclk = wire_sd1_outclk;
endmodule //clk_buffer_altclkctrl_0_sub
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module  clk_buffer_altclkctrl_0  (
    inclk,
    outclk);
    ...
    clk_buffer_altclkctrl_0_sub  clk_buffer_altclkctrl_0_sub_component (
                .ena (sub_wire1),
                .inclk (sub_wire3),
                .outclk (sub_wire0));
