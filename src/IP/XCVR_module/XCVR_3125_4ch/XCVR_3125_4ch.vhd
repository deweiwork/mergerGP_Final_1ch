...
--alt4gxb CBX_AUTO_BLACKBOX="ALL" coreclkout_control_width=1 device_family="Arria II GX" effective_data_rate="2540 Mbps" enable_lc_tx_pll="false" equalizer_ctrl_a_setting=0 equalizer_ctrl_b_setting=0 equalizer_ctrl_c_setting=0 equalizer_ctrl_d_setting=0 equalizer_ctrl_v_setting=1 equalizer_dcgain_setting=0 gen_reconfig_pll="false" gx_channel_type="auto" gxb_analog_power="AUTO" gxb_powerdown_width=1 input_clock_frequency="127.0 MHz" intended_device_speed_grade="3" intended_device_variant="ANY" loopback_mode="slb" number_of_channels=1 number_of_quads=1 operation_mode="duplex" pll_control_width=1 pll_pfd_fb_mode="internal" preemphasis_ctrl_1stposttap_setting=0 preemphasis_ctrl_2ndposttap_inv_setting="false" preemphasis_ctrl_2ndposttap_setting=0 preemphasis_ctrl_pretap_inv_setting="false" preemphasis_ctrl_pretap_setting=0 protocol="basic" receiver_termination="OCT_100_OHMS" reconfig_calibration="true" reconfig_dprio_mode=0 reconfig_fromgxb_port_width=17 reconfig_togxb_port_width=4 rx_8b_10b_mode="none" rx_align_pattern="0101111100" rx_align_pattern_length=10 rx_allow_align_polarity_inversion="false" rx_allow_pipe_polarity_inversion="false" rx_bitslip_enable="false" rx_byte_ordering_mode="none" rx_channel_bonding="indv" rx_channel_width=20 rx_common_mode="0.82v" rx_cru_bandwidth_type="auto" rx_cru_inclock0_period=7874 rx_cru_m_divider=10 rx_cru_n_divider=1 rx_cru_vco_post_scale_divider=2 rx_data_rate=2540 rx_data_rate_remainder=0 rx_datapath_low_latency_mode="false" rx_datapath_protocol="basic" rx_digitalreset_port_width=1 rx_dwidth_factor=2 rx_enable_bit_reversal="false" rx_enable_deep_align_byte_swap="false" rx_enable_lock_to_data_sig="false" rx_enable_lock_to_refclk_sig="false" rx_enable_self_test_mode="false" rx_flip_rx_out="false" rx_force_signal_detect="true" rx_phfiforegmode="false" rx_ppmselect=32 rx_rate_match_fifo_mode="none" rx_run_length=40 rx_run_length_enable="true" rx_signal_detect_loss_threshold=1 rx_signal_detect_threshold=2 rx_signal_detect_valid_threshold=1 rx_use_align_state_machine="true" rx_use_clkout="true" rx_use_coreclk="true" rx_use_cruclk="true" rx_use_deserializer_double_data_mode="true" rx_use_deskew_fifo="false" rx_use_double_data_mode="false" rx_use_external_termination="false" rx_use_rising_edge_triggered_pattern_align="true" rx_word_aligner_num_byte=2 starting_channel_number=0 transmitter_termination="OCT_100_OHMS" tx_8b_10b_mode="none" tx_allow_polarity_inversion="false" tx_analog_power="1.5v" tx_channel_bonding="x4" tx_channel_width=20 tx_clkout_width=1 tx_common_mode="0.65v" tx_data_rate=2540 tx_data_rate_remainder=0 tx_datapath_low_latency_mode="false" tx_digitalreset_port_width=1 tx_dwidth_factor=2 tx_enable_bit_reversal="false" tx_enable_self_test_mode="false" tx_flip_tx_in="false" tx_force_disparity_mode="false" tx_pll_bandwidth_type="auto" tx_pll_clock_post_divider=1 tx_pll_inclk0_period=7874 tx_pll_m_divider=10 tx_pll_n_divider=1 tx_pll_type="CMU" tx_pll_vco_post_scale_divider=2 tx_slew_rate="medium" tx_transmit_protocol="basic" tx_use_coreclk="true" tx_use_double_data_mode="false" tx_use_external_termination="false" tx_use_serializer_double_data_mode="true" use_calibration_block="true" vod_ctrl_setting=4 cal_blk_clk coreclkout pll_inclk pll_locked reconfig_clk reconfig_fromgxb reconfig_togxb rx_clkout rx_coreclk rx_cruclk rx_datain rx_dataout rx_digitalreset rx_enapatternalign rx_freqlocked rx_patterndetect rx_seriallpbken rx_syncstatus tx_clkout tx_coreclk tx_datain tx_dataout tx_digitalreset
--VERSION_BEGIN 18.1 cbx_alt4gxb 2018:09:12:13:04:09:SJ cbx_mgl 2018:09:12:14:15:07:SJ cbx_tgx 2018:09:12:13:04:09:SJ  VERSION_END

 LIBRARY arriaii_hssi;
 USE arriaii_hssi.all;

--synthesis_resources = arriaii_hssi_calibration_block 1 arriaii_hssi_clock_divider 1 arriaii_hssi_cmu 1 arriaii_hssi_pll 2 arriaii_hssi_rx_pcs 1 arriaii_hssi_rx_pma 1 arriaii_hssi_tx_pcs 1 arriaii_hssi_tx_pma 1 reg 3 
 LIBRARY ieee;
 USE ieee.std_logic_1164.all;

 ENTITY  XCVR_3125_4ch_alt4gxb IS 
	 GENERIC 
	 (
	 ...
	 ( 
		 ...
		 rx_coreclk	:	IN  STD_LOGIC_VECTOR (0 DOWNTO 0) := (OTHERS => '0');
		 ...
		 tx_coreclk	:	IN  STD_LOGIC_VECTOR (0 DOWNTO 0) := (OTHERS => '0');
		 tx_datain	:	IN  STD_LOGIC_VECTOR (19 DOWNTO 0) := (OTHERS => '0');
		 tx_dataout	:	OUT  STD_LOGIC_VECTOR (0 DOWNTO 0);
		 tx_digitalreset	:	IN  STD_LOGIC_VECTOR (0 DOWNTO 0) := (OTHERS => '0')
	 ); 
 END XCVR_3125_4ch_alt4gxb;

 ARCHITECTURE RTL OF XCVR_3125_4ch_alt4gxb IS
	 ...
	 SIGNAL  wire_w_lg_reconfig_togxb_busy382w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 ...
	 SIGNAL  wire_w_lg_w_lg_reconfig_togxb_busy453w454w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_lg_reconfig_togxb_busy453w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 ...
	 SIGNAL  int_tx_coreclkout :	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  int_tx_digitalreset_reg :	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  int_tx_phfiforddisableout :	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  int_tx_phfiforesetout :	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  int_tx_phfifowrenableout :	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  int_tx_phfifoxnbytesel :	STD_LOGIC_VECTOR (2 DOWNTO 0);
	 SIGNAL  int_tx_phfifoxnrdclk :	STD_LOGIC_VECTOR (2 DOWNTO 0);
	 SIGNAL  int_tx_phfifoxnrdenable :	STD_LOGIC_VECTOR (2 DOWNTO 0);
	 SIGNAL  int_tx_phfifoxnwrenable :	STD_LOGIC_VECTOR (2 DOWNTO 0);
	 ...
	 SIGNAL  wire_w_coreclkout_wire_range129w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_rx_locktodata_range452w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
 ...
 BEGIN
	...
	wire_gnd <= '0';
	wire_vcc <= '1';
	wire_w_lg_w_lg_reconfig_togxb_busy453w454w(0) <= wire_w_lg_reconfig_togxb_busy453w(0) AND wire_w_rx_locktodata_range452w(0);
	wire_w_lg_reconfig_togxb_busy453w(0) <= NOT reconfig_togxb_busy(0);
	cal_blk_powerdown <= '0';
 ...
 & tx_pmadprioout(299 DOWNTO 0));
	...
	int_tx_coreclkout(0) <= ( wire_transmit_pcs0_coreclkout);
	int_tx_digitalreset_reg(0) <= ( tx_digitalreset_reg0c(2));
	int_tx_phfiforddisableout(0) <= ( wire_transmit_pcs0_phfiforddisableout);
	int_tx_phfiforesetout(0) <= ( wire_transmit_pcs0_phfiforesetout);
	int_tx_phfifowrenableout(0) <= ( wire_transmit_pcs0_phfifowrenableout);
	int_tx_phfifoxnbytesel <= ( int_txphfifox4byteselout(0) & "0" & "0");
	int_tx_phfifoxnrdclk <= ( int_txphfifox4rdclkout(0) & "0" & "0");
	int_tx_phfifoxnrdenable <= ( int_txphfifox4rdenableout(0) & "0" & "0");
	int_tx_phfifoxnwrenable <= ( int_txphfifox4wrenableout(0) & "0" & "0");
	...
	rx_freqlocked(0) <= ( rx_freqlocked_wire(0));
	rx_freqlocked_wire(0) <= ( wire_rx_cdr_pll0_freqlocked);
	rx_locktodata <= (OTHERS => '0');
	rx_locktodata_wire <= ( wire_w_lg_w_lg_reconfig_togxb_busy453w454w);
 ...
 & cent_unit_cmuplldprioout(299 DOWNTO 0));
	...
	tx_digitalreset_in <= ( "000" & int_tx_digitalreset_reg(0));
 ...
 & wire_transmit_pma0_dprioout);
	...
	wire_w_coreclkout_wire_range129w(0) <= coreclkout_wire(0);
	wire_w_rx_locktodata_range452w(0) <= rx_locktodata(0);
	...
	rx_cdr_pll0 :  arriaii_hssi_pll
	  GENERIC MAP (
		...
		inclk0_input_period => 7874,
		input_clock_frequency => "127.0 MHz",
		m => 10,
		n => 1,
		pfd_clk_select => 0,
		pll_type => "RX CDR",
	...
	wire_receive_pcs0_cdrctrllocktorefcl <= wire_w_lg_reconfig_togxb_busy382w(0);
	wire_w_lg_reconfig_togxb_busy382w(0) <= reconfig_togxb_busy(0) OR rx_locktorefclk(0);
	...
	wire_transmit_pma0_pclk <= ( "000" & refclk_pma(0) & "0");
...
ARCHITECTURE RTL OF xcvr_3125_4ch IS
	...
	ATTRIBUTE clearbox_defparam OF RTL: ARCHITECTURE IS "effective_data_rate=2540 Mbps;enable_lc_tx_pll=false;equalizer_ctrl_a_setting=0;equalizer_ctrl_b_setting=0;equalizer_ctrl_c_setting=0;equalizer_ctrl_d_setting=0;equalizer_ctrl_v_setting=1;equalizer_dcgain_setting=0;gen_reconfig_pll=false;gxb_analog_power=AUTO;gx_channel_type=AUTO;input_clock_frequency=127.0 MHz;intended_device_family=Arria II GX;intended_device_speed_grade=3;intended_device_variant=ANY;loopback_mode=slb;lpm_hint=CBX_MODULE_PREFIX=XCVR_3125_4ch;lpm_type=alt4gxb;number_of_channels=1;operation_mode=duplex;pll_control_width=1;pll_pfd_fb_mode=internal;preemphasis_ctrl_1stposttap_setting=0;preemphasis_ctrl_2ndposttap_inv_setting=false;preemphasis_ctrl_2ndposttap_setting=0;preemphasis_ctrl_pretap_inv_setting=false;preemphasis_ctrl_pretap_setting=0;protocol=basic;receiver_termination=oct_100_ohms;reconfig_dprio_mode=0;rx_8b_10b_mode=none;rx_align_pattern=0101111100;rx_align_pattern_length=10;rx_allow_align_polarity_inversion=false;rx_allow_pipe_polarity_inversion=false;rx_bitslip_enable=false;rx_byte_ordering_mode=NONE;rx_channel_bonding=indv;rx_channel_width=20;rx_common_mode=0.82v;rx_cru_bandwidth_type=Auto;rx_cru_inclock0_period=7874;rx_datapath_low_latency_mode=false;rx_datapath_protocol=basic;rx_data_rate=2540;rx_data_rate_remainder=0;rx_digitalreset_port_width=1;rx_enable_bit_reversal=false;rx_enable_deep_align_byte_swap=false;rx_enable_lock_to_data_sig=false;rx_enable_lock_to_refclk_sig=false;rx_enable_self_test_mode=false;rx_flip_rx_out=false;" & 
	                                                    "rx_force_signal_detect=true;rx_phfiforegmode=false;rx_ppmselect=32;rx_rate_match_fifo_mode=none;rx_run_length=40;rx_run_length_enable=true;rx_signal_detect_threshold=2;rx_use_align_state_machine=true;rx_use_clkout=true;rx_use_coreclk=true;rx_use_cruclk=true;rx_use_deserializer_double_data_mode=true;rx_use_deskew_fifo=false;rx_use_double_data_mode=false;rx_use_rising_edge_triggered_pattern_align=true;transmitter_termination=oct_100_ohms;tx_8b_10b_mode=none;tx_allow_polarity_inversion=false;tx_analog_power=1.5v;tx_channel_bonding=x4;tx_channel_width=20;tx_clkout_width=1;tx_common_mode=0.65v;tx_datapath_low_latency_mode=false;tx_data_rate=2540;tx_data_rate_remainder=0;tx_digitalreset_port_width=1;tx_enable_bit_reversal=false;tx_enable_self_test_mode=false;tx_flip_tx_in=false;tx_force_disparity_mode=false;tx_pll_bandwidth_type=Auto;tx_pll_inclk0_period=7874;tx_pll_type=CMU;tx_slew_rate=medium;tx_transmit_protocol=basic;tx_use_coreclk=true;tx_use_double_data_mode=false;tx_use_serializer_double_data_mode=true;use_calibration_block=true;vod_ctrl_setting=4;coreclkout_control_width=1;gxb_powerdown_width=1;number_of_quads=1;reconfig_calibration=true;reconfig_fromgxb_port_width=17;reconfig_togxb_port_width=4;rx_cru_m_divider=10;rx_cru_n_divider=1;rx_cru_vco_post_scale_divider=2;rx_dwidth_factor=2;rx_signal_detect_loss_threshold=1;rx_signal_detect_valid_threshold=1;rx_use_external_termination=false;rx_word_aligner_num_byte=2;tx_dwidth_factor=2;tx_pll_clock_post_divider=1;tx_pll_m_divider=10;tx_pll_n_divider=1;" & 
	...
	COMPONENT XCVR_3125_4ch_alt4gxb
	GENERIC (
...
BEGIN
	...
	rx_clkout    <= sub_wire3(0 DOWNTO 0);
	rx_dataout    <= sub_wire4(19 DOWNTO 0);
	rx_freqlocked    <= sub_wire5(0 DOWNTO 0);
	rx_patterndetect    <= sub_wire6(1 DOWNTO 0);
	rx_syncstatus    <= sub_wire7(1 DOWNTO 0);
	tx_clkout    <= sub_wire8(0 DOWNTO 0);
	tx_dataout    <= sub_wire9(0 DOWNTO 0);

	XCVR_3125_4ch_alt4gxb_component : XCVR_3125_4ch_alt4gxb
	GENERIC MAP (
...
-- Retrieval info: PRIVATE: WIZ_BASE_DATA_RATE STRING "2540.0"
-- Retrieval info: PRIVATE: WIZ_BASE_DATA_RATE_ENABLE STRING "0"
-- Retrieval info: PRIVATE: WIZ_DATA_RATE STRING "2540"
...
-- Retrieval info: PRIVATE: WIZ_DPRIO_REF_CLK0_FREQ STRING "127.0"
...
-- Retrieval info: PRIVATE: WIZ_INCLK_FREQ STRING "127.0"
-- Retrieval info: PRIVATE: WIZ_INCLK_FREQ_ARRAY STRING "50.8 63.5 79.375 101.6 127.0 158.75 203.2 254.0 317.5 406.4 508.0"
-- Retrieval info: PRIVATE: WIZ_INPUT_A STRING "2540"
-- Retrieval info: PRIVATE: WIZ_INPUT_A_UNIT STRING "Mbps"
-- Retrieval info: PRIVATE: WIZ_INPUT_B STRING "127.0"
...
-- Retrieval info: CONSTANT: EFFECTIVE_DATA_RATE STRING "2540 Mbps"
...
-- Retrieval info: CONSTANT: INPUT_CLOCK_FREQUENCY STRING "127.0 MHz"
...
-- Retrieval info: CONSTANT: RX_CRU_INCLOCK0_PERIOD NUMERIC "7874"
-- Retrieval info: CONSTANT: RX_DATAPATH_LOW_LATENCY_MODE STRING "false"
-- Retrieval info: CONSTANT: RX_DATAPATH_PROTOCOL STRING "basic"
-- Retrieval info: CONSTANT: RX_DATA_RATE NUMERIC "2540"
...
-- Retrieval info: CONSTANT: TX_DATA_RATE NUMERIC "2540"
...
-- Retrieval info: CONSTANT: TX_PLL_INCLK0_PERIOD NUMERIC "7874"
...
-- Retrieval info: USED_PORT: rx_coreclk 0 0 1 0 INPUT NODEFVAL "rx_coreclk[0..0]"
...
-- Retrieval info: USED_PORT: tx_coreclk 0 0 1 0 INPUT NODEFVAL "tx_coreclk[0..0]"
...
-- Retrieval info: GEN_FILE: TYPE_NORMAL XCVR_3125_4ch.vhd TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL XCVR_3125_4ch.ppf TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL XCVR_3125_4ch.inc FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL XCVR_3125_4ch.cmp TRUE
-- Retrieval info: GEN_FILE: TYPE_NORMAL XCVR_3125_4ch.bsf FALSE
-- Retrieval info: GEN_FILE: TYPE_NORMAL XCVR_3125_4ch_inst.vhd FALSE
